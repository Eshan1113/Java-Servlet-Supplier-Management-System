                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="editsupplierdetails.jsp" method="post">
                            ...
                            <div class="col-md-12">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <li class="page-item <%= (currentPage == 1) ? "disabled" : ""%>">
                                        <a class="page-link" href="editsupplier.jsp?currentPage=<%= currentPage - 1%>" aria-label="Previous">
                                    ...
                                    <li class="page-item <%= (currentPage == i) ? "active" : ""%>">
                                        <a class="page-link" href="editsupplier.jsp?currentPage=<%= i%>"><%= i%></a>
                                    </li>
                                    <%
                                        }
                                    %>
                                    ...
                                    <li class="page-item <%= (currentPage == totalPages) ? "disabled" : ""%>">
                                        <a class="page-link" href="editsupplier.jsp?currentPage=<%= currentPage + 1%>" aria-label="Next">
